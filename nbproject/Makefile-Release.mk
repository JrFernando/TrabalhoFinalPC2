...
${OBJECTDIR}/Sources/BD/teste.o: Sources/BD/teste.c
	${MKDIR} -p ${OBJECTDIR}/Sources/BD
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/BD/teste.o Sources/BD/teste.c
...
${OBJECTDIR}/Sources/MODELO/empresa_funcoes.o: Sources/MODELO/empresa_funcoes.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/MODELO/empresa_funcoes.o Sources/MODELO/empresa_funcoes.c

${OBJECTDIR}/Sources/MODELO/fabricante_funcoes.o: Sources/MODELO/fabricante_funcoes.c
	${MKDIR} -p ${OBJECTDIR}/Sources/MODELO
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/MODELO/fabricante_funcoes.o Sources/MODELO/fabricante_funcoes.c

${OBJECTDIR}/Sources/MODELO/funcionario_funcoes.o: Sources/MODELO/funcionario_funcoes.c
	${MKDIR} -p ${OBJECTDIR}/Sources/MODELO
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/MODELO/funcionario_funcoes.o Sources/MODELO/funcionario_funcoes.c

${OBJECTDIR}/Sources/MODELO/produtos_funcoes.o: Sources/MODELO/produtos_funcoes.c
	${MKDIR} -p ${OBJECTDIR}/Sources/MODELO
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/MODELO/produtos_funcoes.o Sources/MODELO/produtos_funcoes.c
